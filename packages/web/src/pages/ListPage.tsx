    ...
    <div className="space-y-4" onClick={() => {}}>
      ...
      {checkedItems.length > 0 && (
        <div className="space-y-1">
          <p className="text-xs text-gray-400 font-medium px-1">完了 ({checkedItems.length})</p>
          {checkedItems.map((item) => (
            ...
            >
              ...
              <div className="flex-1 flex items-center gap-3 px-3 py-2">
                <button
                  onClick={() => handleToggle(item)}
                  className="w-[18px] h-[18px] rounded-full border-2 border-primary-500 bg-primary-500 flex items-center justify-center flex-shrink-0"
                >
